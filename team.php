...
<head>
    ...
    <meta name="keywords" content="Socail Media Marketing,Graphic Designs , Website Design & Development , Team Work">
    ...
    <title>Team | MG Marketing Kenya</title>
...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid position-relative bg-primary py-5 mb-5 page-header" style=" background-image:url(img/DSC_9340.jpg)">
